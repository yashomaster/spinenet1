...
model = dict(
    ...
    roi_head=dict( # RoIHead encapsulates the second stage of two-stage/cascade detectors.
        ...
        bbox_head=dict( # Config of box head in the RoIHead.
            ...
            num_classes=52, # Number of classes for classification
        ...
        mask_head=dict( # Mask prediction head
            ...
            num_classes=52, # Number of class to be segmented.
            norm_cfg=norm_cfg,
...
auto_scale_lr = dict(enable=True, base_batch_size=32) # https://github.com/open-mmlab/mmdetection/pull/7482 # 기본 LR 사용하지 않는 방법

# Note : This is for automatically scaling LR, USER CAN'T CHANGE THIS VALUE
mmdet_official_special_batch_size = 32 # https://github.com/open-mmlab/mmdetection/pull/7377
