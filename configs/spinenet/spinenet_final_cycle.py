...
auto_scale_lr = dict(enable=True, base_batch_size=8) # https://github.com/open-mmlab/mmdetection/pull/7482 # 기본 LR 사용하지 않는 방법

# Note : This is for automatically scaling LR, USER CAN'T CHANGE THIS VALUE
mmdet_official_special_batch_size = 8 # https://github.com/open-mmlab/mmdetection/pull/7377
